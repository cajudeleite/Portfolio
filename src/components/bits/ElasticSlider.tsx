...
const Slider: React.FC<SliderProps> = ({
  ...
  const [value, setValue] = useState<number>(fpsThreshold);
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div className="relative h-full flex-grow overflow-hidden rounded-full bg-dark">
              <div className="absolute h-full bg-light rounded-full" style={{ width: `${getRangePercentage()}%` }} />
            </div>
          </motion.div>
        </div>
